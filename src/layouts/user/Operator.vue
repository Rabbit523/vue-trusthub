...
<template>
  ...
  >
    ...
    <v-nav-menu :navMenuItems="navMenuItems" title="Trusthub" parent=".layout--main" />
...
import HNavMenu from '@/components/layout/horizontal-nav-menu/HorizontalNavMenu.vue'

import navMenuItems from '@/views/user/operator/slidelist.js'

import TheCustomizer from '@/components/layout/customizer/TheCustomizer.vue'
import TheNavbarHorizontal from '@/components/layout/navbar/TheNavbarHorizontal.vue'
import TheNavbarVertical from '@/components/layout/navbar/TheNavbarVertical.vue'
import TheFooter from '@/components/layout/TheFooter.vue'
import themeConfig from '@/../themeConfig.js'
import VNavMenu from '@/components/layout/vertical-nav-menu/VerticalNavMenu.vue'

const VxTour = () => import('@/components/vx/VxTour.vue')
...
export default {
  ...
  created () {
    // Auth Guard
    TrusthubUser.authGuard(this.$store, 'operator')
