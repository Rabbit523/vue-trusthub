...
const router = new Router({
  ...
  routes: [
    // ******************************************************************************
    // Original Routes (New Dashboard Routes)
    // ******************************************************************************
    ...
    {
      path: '/admin/',
      component: () => import('./layouts/trusthub/Admin.vue'),
      children: [
    ...
    {
      path: '/partner/',
      component: () => import('./layouts/trusthub/Partner.vue'),
      children: [
        ...
        // Customers
        {
          ...
          redirect: '/partner/customers/list'
        },
        {
    ...
    {
      path: '/customer/',
      component: () => import('./layouts/trusthub/Customer.vue'),
      children: [

        // Dashboard Analytics
        {
          path: '/customer/',
          redirect: '/customer/analytics'
        },
        {
        ...
        // Operators
        {
          ...
          redirect: '/customer/operators/modify'
        },
        {
          path: '/customer/operators/modify',
          name: 'customer-operators-modify',
    ...
    {
      path: '/operator/',
      component: () => import('./layouts/trusthub/Operator.vue'),
      children: [

        // Dashboard Analytics
        {
          path: '/operator/',
          redirect: '/operator/analytics'
        },
        {
        ...
        // Sequences
        {
          path: '/operator/sequences/',
          redirect: '/operator/sequences/identify'
        },
        {
    ...
    {
      path: '/person/',
      component: () => import('./layouts/trusthub/Person.vue'),
      children: [
        ...
        // Notifications
        {
          ...
          redirect: '/person/notifications/sent'
        },
        {
        ...
        // signature
        {
          path: '/person/signature/',
          redirect: '/person/signature/upload'
        },
        {
          path: '/person/signature/upload',
          name: 'person-signature-upload',
          component: () => import('@/views/apps/user/user-list/UserList.vue'),
          meta: {
            pageTitle: 'Signature Upload',
            rule: 'editor'
          }
        },
        {
          path: '/person/signature/sign',
          name: 'person-signature-sign',
          component: () => import('@/views/apps/user/user-list/UserList.vue'),
          meta: {
            pageTitle: 'Signature To Sign',
            rule: 'editor'
          }
        },
        {
          path: '/person/signature/signed',
          name: 'person-signature-signed',
          component: () => import('@/views/apps/user/user-list/UserList.vue'),
          meta: {
            pageTitle: 'Signature Signed',
            rule: 'editor'
          }
        },
        ...
        {
          path: '/person/apps/',
          redirect: '/person/apps/email/inbox'
        },
        {
    ...
    // ******************************************************************************
    // Development Routes (Default Dashboard Routes)
    // ******************************************************************************
    {
    // =============================================================================
    // MAIN LAYOUT ROUTES
