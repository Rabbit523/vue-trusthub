        ...
        <div class="header-sidebar flex items-end justify-between" slot="header">
          ...
          <div>
            ...
            <template v-if="showCloseButton">
              <feather-icon icon="XIcon" class="m-0 cursor-pointer dev-close-white" @click="$store.commit('TOGGLE_IS_VERTICAL_NAV_MENU_ACTIVE', false)" />
            </template>

            <!-- Toggle Buttons -->
            <template v-else-if="!showCloseButton && !verticalNavMenuItemsMin">
              <img src="@/assets/images/trusthub/menu.png" class="dev-pointer" width="25" alt="menu icon"  @click="toggleReduce(!reduce)" />
              <!-- <feather-icon
