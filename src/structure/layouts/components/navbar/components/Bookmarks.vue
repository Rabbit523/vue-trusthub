    ...
    <ul class="vx-navbar__starred-pages dev-contain-leftbtns">
      <li>
        <vx-tooltip text="Identification" position="bottom" delay=".3s">
          <img src="@/assets/images/trusthub/DNI.png" alt="dni icon" />
        </vx-tooltip>
      </li>
      <li>
        <vx-tooltip text="Face" position="bottom" delay=".3s">
          <img src="@/assets/images/trusthub/face.png" alt="Face icon" />
        </vx-tooltip>
      </li>
      <li>
        <vx-tooltip text="Fingerprint" position="bottom" delay=".3s">
          <img src="@/assets/images/trusthub/finger.png" alt="dni icon" />
        </vx-tooltip>
      </li>
      <li>
        <vx-tooltip text="Voice" position="bottom" delay=".3s">
          <img src="@/assets/images/trusthub/voice.png" alt="Voice icon" />
        </vx-tooltip>
      </li>
    </ul>
    <!-- Status Life Proof  -->
