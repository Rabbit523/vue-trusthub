<template>
  <vs-dropdown vs-custom-content vs-trigger-click class="cursor-pointer">
    ...
    <vs-dropdown-menu class="w-48 i18n-dropdown vx-navbar-dropdown">
      ...
      <vs-dropdown-item @click="updateLocale('fr')"><img class="h-4 w-5 mr-1" src="@/assets/images/flags/sp.png" alt="fr" /> &nbsp;Spanish</vs-dropdown-item>
      ...
      <vs-dropdown-item @click="updateLocale('de')"><img class="h-4 w-5 mr-1" src="@/assets/images/flags/it.png" alt="de" /> &nbsp;Italian</vs-dropdown-item>
    </vs-dropdown-menu>
  </vs-dropdown>
</template>
